...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 216, 97, 237),
        title: Text("GÜNÜN FALI",style: TextStyle(color: Colors.white),),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Card(
              ...
              child: ListTile(
                leading: Icon(Icons.shopping_cart,color:Color.fromARGB(255, 57, 232, 63)),
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: Text("GÜNLÜK ÖNERİ",style: TextStyle(color: Colors.blue),),
                onTap: (){
                  setState(() {
